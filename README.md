...
- **Sigma-derived OCI query artifacts:** 554
  - 546 top-level detections in `queries/*.json`
...
- **Source rule breakdown:** Windows (303), Cloud/OCI (102), Linux (80), Web/WAF (38)
...
- **Atomic Red Team coverage:** 280 / 398 testable rules have ART mappings (70.4%)
