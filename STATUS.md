...
- Generated demo data: 25 NDJSON files / 93,142 events in the latest local `test_data/manifest.json`, including the optional Octo APM workshop dataset generated by the default `scripts/prepare_threat_hunting_demo.py` workflow
...
- `python3 scripts/deploy_dashboard.py --dry-run`
  - 34 dashboards / 536 saved searches resolved from generated inventory
