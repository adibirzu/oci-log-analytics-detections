...
- Any Mode 1 production package uses a reviewed `adibirzu/oci-splunk` tag or commit and must not track mutable `main`; current provenance is `2.2.0` at `a98167404f19be6d18235bccbf1113b59a259c4c`.
