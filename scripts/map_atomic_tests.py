...
def enrich_queries(art_index, dry_run=False):
...
def generate_coverage_report(art_index):
...
def main():
    ...
    if args.enrich:
        ...
        stats = enrich_queries(art_index, dry_run=args.dry_run)
